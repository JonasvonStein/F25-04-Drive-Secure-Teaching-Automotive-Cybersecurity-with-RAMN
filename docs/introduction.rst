...
-----------------------
We have made three challenges. To know what you need to install, go to the :doc:`softwareInstallation` section. The challenges are beginner-friendly, and you can go to the :doc:`challengeHints` section for extra help.
