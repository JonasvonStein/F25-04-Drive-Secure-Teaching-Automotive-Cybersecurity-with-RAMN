...
and then you will be able to inject CAN frames via the command line or script using Python to loop and send commands
...
where wireless connectivity is an option. In the future, there may be an expansion of the RAMN system that allows
